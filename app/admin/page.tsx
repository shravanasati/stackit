...
import {
  ...
  SecurityLogType,
  SecurityLogs,
} from "@/components/SecurityLogs";
import { Unauthorized } from "@/components/Unauthorized";
import { getOTPCount } from "@/lib/database/firestore";
import { getUnresolvedReports } from "@/lib/database/reports";
import { getSecurityLogs } from "@/lib/database/security_log";
    ...
    <div className="container mx-2 py-8">
      ...
      <div className="m-2 bg-primary/10 w-fit p-2 rounded-xl">
        ...
        <p className="text-xl font-semibold">
          Emails attempted sign in: {otpCount}
        </p>
      </div>
      ...
      <div className="m-2">
        <h1 className="text-2xl font-bold my-6">Broadcast Notification</h1>
